...
from ..config.constants import COMMAND_TERMINATOR, DIRECTION_MAP, MOTOR_NAMES
...
class CommandGenerator:
    ...
    def generate_command(self, step_params: Dict[str, Any], mode: str = "manual") -> str:
        """
        生成电机控制指令
    ...
    def generate_calibration_command(self, selected_motors: Set[str]) -> str:
        """
        生成校准指令
