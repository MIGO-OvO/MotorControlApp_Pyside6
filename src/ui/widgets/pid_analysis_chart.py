...
from PySide6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QGridLayout,
                                QGroupBox, QLabel, QFrame, QPushButton, QFileDialog)
    ...
    def _init_ui(self):
        ...
        for motor in ["X", "Y", "Z", "A"]:
            ...
            self.position_curves[motor]["target"] = self.position_plot.plot(
                pen=pg.mkPen(color=POSITION_STYLES["target"]["color"], 
            ...
            self.position_curves[motor]["theo"] = self.position_plot.plot(
                pen=pg.mkPen(color=POSITION_STYLES["theo"]["color"],
        ...
        # 添加零线
        zero_line2 = pg.InfiniteLine(pos=0, angle=0,
            pen=pg.mkPen(color='#888888', width=1, style=Qt.DashLine))
    ...
    def update_from_packet(self, motor: str, packet: dict, relative_time: float):
        ...
        try:
            ...
            if motor in self.position_data:
                self.position_data[motor].append((relative_time, target_rotation, relative_actual, relative_theo))
